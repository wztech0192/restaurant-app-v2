...
namespace RestaurantApp.DAL.Migrations
{
    ...
    [Migration("20201014190801_change_menu_name")]
    partial class change_menu_name
    {
            ...
            modelBuilder.Entity("RestaurantApp.DAL.Models.Account", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ID = 1,
                            CreatedOn = new DateTime(2020, 10, 14, 15, 8, 1, 279, DateTimeKind.Local).AddTicks(9457),
                            Email = "weijie0192@gmail.com",
                            Name = "Manager",
                            Password = "$2a$11$GiM/EcCMRdNVlUht4kzxbu4M6RoqojreUtIjHBm20TpSCFz8vGLU2",
                            Role = "Manager"
                        });
                });
