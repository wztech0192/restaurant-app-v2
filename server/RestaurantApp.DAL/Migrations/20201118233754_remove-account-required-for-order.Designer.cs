...
namespace RestaurantApp.DAL.Migrations
{
    ...
    [Migration("20201118233754_remove-account-required-for-order")]
    partial class removeaccountrequiredfororder
    {
            ...
            modelBuilder.Entity("RestaurantApp.DAL.Models.Account", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ID = 1,
                            CreatedOn = new DateTime(2020, 11, 18, 18, 37, 53, 746, DateTimeKind.Local).AddTicks(6257),
                            Name = "Manager",
                            Password = "$2a$11$GlQzkJFtH69a99d0m47bMOwdbX5edMnoEGtmfvU23y5Ai5oBWyFNS",
                            Phone = "8032260689",
                            Role = "Manager"
                        });
                });
