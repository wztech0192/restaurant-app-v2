...
namespace RestaurantApp.DAL.Migrations
{
    ...
    [Migration("20201115042111_change_last_4_digit_from_int_to_string")]
    partial class change_last_4_digit_from_int_to_string
    {
            ...
            modelBuilder.Entity("RestaurantApp.DAL.Models.Account", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ID = 1,
                            CreatedOn = new DateTime(2020, 11, 14, 23, 21, 10, 334, DateTimeKind.Local).AddTicks(8860),
                            Email = "weijie0192@gmail.com",
                            Name = "Manager",
                            Password = "$2a$11$b8ludwvNeEZvPaFjhiSOFOe192RQI3JzLwbEcWUF2U4Y9Tpg9dzWS",
                            Role = "Manager"
                        });
                });
