...
namespace RestaurantApp.DAL.Migrations
{
    ...
    [Migration("20201122061635_add_rule_cascade")]
    partial class add_rule_cascade
    {
            ...
            modelBuilder.Entity("RestaurantApp.DAL.Models.Account", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ID = 1,
                            CreatedOn = new DateTime(2020, 11, 22, 1, 16, 34, 17, DateTimeKind.Local).AddTicks(9982),
                            Name = "Manager",
                            Password = "$2a$11$mDVnZFog5hTrNkIcoy/RzOzxgSGG4/YCAkyRAZtTXXMoK66ptpD2W",
                            Phone = "8032260689",
                            Role = "Manager"
                        });
                });
