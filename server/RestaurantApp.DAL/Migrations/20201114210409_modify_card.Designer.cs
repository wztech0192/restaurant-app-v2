...
namespace RestaurantApp.DAL.Migrations
{
    ...
    [Migration("20201114210409_modify_card")]
    partial class modify_card
    {
            ...
            modelBuilder.Entity("RestaurantApp.DAL.Models.Account", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ID = 1,
                            CreatedOn = new DateTime(2020, 11, 14, 16, 4, 8, 706, DateTimeKind.Local).AddTicks(2173),
                            Email = "weijie0192@gmail.com",
                            Name = "Manager",
                            Password = "$2a$11$pJLPm9fzwsSfBeLTyrwNPeaf6At699sDnyKDXL.vEz3eLxUN3Jnsq",
                            Role = "Manager"
                        });
                });
